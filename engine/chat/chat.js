...
function hosting(channel, target, viewers, unhost) {
	...
	function addAsyncCall(channel) {
		...
		data = {"channelEmotes": [
			...
			{"id": "60a8d02c67644f1d67e8ace7", "code":"NOPERS", "imgType":"png"},
			{"id": "60aad9d367644f1d67e8bbb8", "code":"Susge", "imgType":"png"},
			{"id": "60cd10e38ed8b373e4216014", "code":"FeelsOkayMan", "imgType":"png"},
			{"id": "5ae5d2f620eeab46b4c44a8c", "code":"pepeW", "imgType":"png"},
			{"id": "60588cbadfaae06e7d60c51c", "code":"forsenPls", "imgType":"png"},
			{"id": "5e1ddb01bca2995f13fb70be", "code":"BillyApprove", "imgType":"png"},
			{"id": "5ff954573095a904e6daa5c3", "code":"gachiGASM", "imgType":"png"},
			{"id": "60a4403367644f1d67e88bb2", "code":"RareParrot", "imgType":"png"},
			{"id": "607871e839b5010444cffc94", "code":"eShrug", "imgType":"png"},
			{"id": "5fedefa19d7d952e4059e68c", "code":"pepePoint", "imgType":"png"},
			{"id": "5c36fba2c6888455faa2e29f", "code":"pepeJAMJAM", "imgType":"gif"},
			{"id": "5e1b12868af14b5f1b43921d", "code":"ModTime", "imgType":"gif"},
			{"id": "603bc47b7c74605395f35ecb", "code":"WTFF", "imgType":"png"},
			{"id": "60634865a407570b72f27f82", "code":"D!ANO", "imgType":"gif"},
			{"id": "60634865a407570b72f27f82", "code":"DAINO", "imgType":"gif"},
		], "sharedEmotes":[]};
		mergeBTTVEmotes(data, channel); 
